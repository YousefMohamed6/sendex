...
mixin _$OrderState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T orders) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(T orders)? success,
...
abstract class $OrderStateCopyWith<T, $Res> {
  factory $OrderStateCopyWith(
    OrderState<T> value,
    $Res Function(OrderState<T>) then,
...
abstract class Initial<T> implements OrderState<T> {
...
abstract class Loading<T> implements OrderState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
  ...
  @override
  $Res call({Object? orders = freezed}) {
    return _then(
      _$SuccessImpl<T>(
        freezed == orders
            ? _value.orders
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'OrderState<$T>.success(orders: $orders)';
  }
...
abstract class Success<T> implements OrderState<T> {
  const factory Success(final T orders) = _$SuccessImpl<T>;
...
abstract class Failure<T> implements OrderState<T> {
